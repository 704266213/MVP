...
public class PtrClassicDefaultHeader extends FrameLayout implements PtrUIHandler {
    ...
    private final static String KEY_SharedPreferences = "classic_last_update";
    ...
    protected void initViews(AttributeSet attrs) {
        ...
        mTitleTextView = header.findViewById(R.id.header_rotate_view_header_title);
        mLastUpdateTextView = header.findViewById(R.id.header_rotate_view_header_last_update);
